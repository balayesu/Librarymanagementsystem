...
<div class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="genreco.php" class="small-box-footer">Visit <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
        </div>
          <br><br>
  ...
  <footer class="main-footer">
    <strong>Contact Us <a href="#">hebabh@gmail.com</a>.</strong>
    All rights reserved.
      </footer>
